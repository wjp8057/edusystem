...
##2016-11-26
--插入考试安排部分的权限控制
insert into action(ACTION,DESCRIPTION,IMAGE,PARENTID,ISMENU,RANK)
('/exam/index/finalauto',,自动排考','icon-caluate',1480,1,2),
('/exam/end/autoquery','检索课程','icon-blank',1564,0,0),
('/exam/end/lockfree','锁定解锁课程','icon-blank',1564,0,1),
('/exam/end/autoinit','初始化数据','icon-blank',1564,0,2),
('/exam/end/schedule','开始排考','icon-blank',1564,0,3),
('/exam/end/loadcourse','载入课程','icon-blank',1564,0,0),
('/exam/end/autoupdate','更新课程信息','icon-blank',1564,0,0),
('/exam/end/exportexcel','导出到excel','icon-blank',1564,0,6)
...
ALTER TABLE [dbo].[TESTPLAN] ADD  CONSTRAINT [DF_TESTPLAN_ROOMNO1]  DEFAULT ('/') FOR [ROOMNO1]
ALTER TABLE [dbo].[TESTPLAN] ADD  CONSTRAINT [DF_TESTPLAN_seats1]  DEFAULT ((0)) FOR [SEATS1]
ALTER TABLE [dbo].[TESTPLAN] ADD  CONSTRAINT [DF_TESTPLAN_rs1]  DEFAULT ((0)) FOR [RS1]
ALTER TABLE [dbo].[TESTPLAN] ADD  CONSTRAINT [DF_TESTPLAN_ROOMNO2]  DEFAULT ('/') FOR [ROOMNO2]
ALTER TABLE [dbo].[TESTPLAN] ADD  CONSTRAINT [DF_TESTPLAN_seats2]  DEFAULT ((0)) FOR [SEATS2]
ALTER TABLE [dbo].[TESTPLAN] ADD  CONSTRAINT [DF_TESTPLAN_rs2]  DEFAULT ((0)) FOR [RS2]
ALTER TABLE [dbo].[TESTPLAN] ADD  CONSTRAINT [DF_TESTPLAN_ROOMNO3]  DEFAULT ('/') FOR [ROOMNO3]
ALTER TABLE [dbo].[TESTPLAN] ADD  CONSTRAINT [DF_TESTPLAN_seats3]  DEFAULT ((0)) FOR [SEATS3]
ALTER TABLE [dbo].[TESTPLAN] ADD  CONSTRAINT [DF_TESTPLAN_rs3]  DEFAULT ((0)) FOR [RS3]
ALTER TABLE [dbo].[TESTPLAN] ADD  CONSTRAINT [DF_TESTPLAN_ATTENDENTS]  DEFAULT ((0)) FOR [ATTENDENTS]
