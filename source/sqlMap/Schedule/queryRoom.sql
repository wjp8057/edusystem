...
CLASSROOMS.JSN,CLASSROOMS.SEATS,CLASSROOMS.TESTERS,CLASSROOMS.RESERVED
FROM CLASSROOMS
...
AND (ISNULL(TIMELIST.SUN,0) & :SUN=0) AND CLASSROOMS.ROOMNO LIKE :ROOMNO AND CLASSROOMS.JSN LIKE :JSN
AND CLASSROOMS.PRIORITY LIKE :PRIORITY AND CLASSROOMS.EQUIPMENT LIKE :EQUIPMENT AND CLASSROOMS.AREA LIKE :AREA
AND CLASSROOMS.SEATS>=:MINSEATS AND CLASSROOMS.SEATS<=:MAXSEATS
