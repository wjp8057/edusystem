SELECT  DISTINCT S.SCHOOL,S.NAME SCHOOLNAME,T.TEACHERNO,T.NAME TEACHERNAME, S2.NAME SEX,P.VALUE 
  ...
  (SELECT TEACHERNO FROM TEACHERPLAN WHERE YEAR = :YEAR AND TERM LIKE :TERM) ORDER BY S.SCHOOL