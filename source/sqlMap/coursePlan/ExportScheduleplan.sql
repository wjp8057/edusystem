SELECT
    ...
    dbo.GROUP_CONCAT_MERGE(RTRIM(CLASSES.CLASSNAME),'/') AS  CLASSNAME,
		dbo.GROUP_CONCAT_MERGE(RTRIM(THETEACHERS.TEACHERNAME),'/') as SXJNAME,
		dbo.GROUP_CONCAT_MERGE(RTRIM(L_ZC.ZC),'/') as SXJPOTION,
    dbo.GROUP_CONCAT_MERGE(RTRIM(THETEACHERS.TASK),'/') as SXJTASK
FROM SCHEDULEPLAN 
